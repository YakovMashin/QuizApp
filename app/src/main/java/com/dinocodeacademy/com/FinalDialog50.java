...
public class FinalDialog50 extends FinalDialog100{


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_final_dialog50);

        bt_Menu = findViewById(R.id.back_to_menu_btn);
        bt_details = findViewById(R.id.details_btn);

        bt_Menu.setOnClickListener(view -> {
            Intent intent = new Intent(FinalDialog50.this, PlayActivity.class);
        ...
        bt_details.setOnClickListener(view -> intentPutExtra(score,totalQuestion,correctQues,wrongQues,category,Level));
